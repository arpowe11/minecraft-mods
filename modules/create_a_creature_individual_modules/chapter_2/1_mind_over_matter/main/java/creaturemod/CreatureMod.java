...
public class CreatureMod
{
    ...
    public static EntityType<ZombieChicken> zombieChicken;
    ...
    public CreatureMod() {
        ...
        zombieChicken = EntityType.Builder.of(ZombieChicken::new, MobCategory.MONSTER).sized(1F, 1F).build("zombie_chicken");


        // ****************** REGISTER MOBS ******************
        Codakid.registerMobEntity(myMobType, "my_mob", Color.orange.getRGB(), Color.black.getRGB());
        Codakid.registerMobEntity(zombieChicken, "zombie_chicken", Color.green.getRGB(), Color.white.getRGB());
    ...
    public void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(zombieChicken, RenderZombieChicken::new);
